        ...
        <div class="col-md-4">
            <div class="card modern-card">
                <div class="card-header d-flex align-items-center gap-2">
                    ...
                    <h5 class="card-title mb-0"><?php echo e(__('User Profile')); ?></h5>
                </div>
        ...
        <div class="col-md-8">
            ...
            <div class="card modern-card">
                <div class="card-header d-flex align-items-center gap-2">
                    ...
                    <h5 class="card-title mb-0"><?php echo e(__('Personal Information')); ?></h5>
                </div>
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="info-item">
                                <label class="form-label fw-bold"><?php echo e(__('Role')); ?></label>
                        ...
                        <div class="col-md-6">
                            <div class="info-item">
                                <label class="form-label fw-bold"><?php echo e(__('Account Balance')); ?></label>
                        ...
                        <div class="col-md-6">
                            <div class="info-item">
                                <label class="form-label fw-bold"><?php echo e(__('Member Since')); ?></label>
            ...
            <div class="card modern-card">
                <div class="card-header d-flex align-items-center gap-2">
                    ...
                    <h5 class="card-title mb-0"><?php echo e(__('Account Status')); ?></h5>
                </div>
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="status-item d-flex align-items-start gap-3">
                                <div class="status-icon <?php echo e($user->approved_at ? 'text-success' : 'text-warning'); ?>">
                                    <i class="fas <?php echo e($user->approved_at ? 'fa-check-circle' : 'fa-clock'); ?> fa-2x"></i>
                                </div>
                                <div class="status-content">
                                    <h6 class="mb-1"><?php echo e(__('Approval Status')); ?></h6>
                        ...
                        <div class="col-md-6">
                            <div class="status-item d-flex align-items-start gap-3">
                                <div class="status-icon <?php echo e($user->email_verified_at ? 'text-success' : 'text-danger'); ?>">
                                    <i class="fas <?php echo e($user->email_verified_at ? 'fa-shield-check' : 'fa-shield-exclamation'); ?> fa-2x"></i>
                                </div>
                                <div class="status-content">
                                    <h6 class="mb-1"><?php echo e(__('Email Verification')); ?></h6>
                                    <p class="mb-0 text-muted">
            ...
            <div class="card modern-card">
                ...
                <div class="card-body">
                    ...
                    <div class="activity-timeline">
                        ...
                        <div class="activity-item d-flex align-items-start gap-3 mb-3">
                            <div class="activity-icon">
                                <i class="fas <?php echo e($activity['icon'] ?? 'fa-circle'); ?> text-primary"></i>
                            </div>
                    ...
                    <div class="empty-state text-center py-4">
                        ...
                        <h5 class="text-muted"><?php echo e(__('No Recent Activity')); ?></h5>
                        <p class="text-muted"><?php echo e(__('This user has no recent activity to display.')); ?></p>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp1\htdocs\easy\resources\views/admin/users/show.blade.php ENDPATH**/ ?>