...
// CheckInstallationMode is applied globally from bootstrap/app.php to run BEFORE everything
Route::middleware([CheckMaintenanceMode::class])->group(function (): void {
