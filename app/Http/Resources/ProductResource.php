...
class ProductResource extends JsonResource
{
    ...
    public function toArray(\Illuminate\Http\Request $request): array
    {
        return [
            ...
            'main_image' => $this->main_image ? \App\Helpers\GlobalHelper::storageImageUrl($this->main_image) : null,
            'gallery' => $this->gallery ? array_map(fn ($img) => \App\Helpers\GlobalHelper::storageImageUrl($img), $this->gallery) : [],
            ...
            'variations' => $this->whenLoaded('variations', function () {
                return $this->variations->map(function ($v) {
                    return [
                        ...
                        'image' => $v->image ? \App\Helpers\GlobalHelper::storageImageUrl($v->image) : null,
                        'name' => $v->name,
