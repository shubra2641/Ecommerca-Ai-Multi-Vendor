<!-- Sidebar -->
            ...
            <nav class="sidebar-nav">
                <?php if(auth()->check() && Gate::allows('access-admin')): ?>
                    ...
                    <div class="nav-section">
                        ...
                        <div class="nav-dropdown dropdown <?php echo e(request()->routeIs('admin.reports*') || request()->routeIs('admin.activity*') || request()->routeIs('admin.performance.*') ? 'show' : ''); ?>">
                            <a href="#" class="nav-item dropdown-toggle" data-bs-toggle="dropdown"
                                aria-expanded="<?php echo e((request()->routeIs('admin.reports*') || request()->routeIs('admin.activity*') || request()->routeIs('admin.performance.*')) ? 'true' : 'false'); ?>">
                                <div class="nav-icon">
                            ...
                            <ul class="dropdown-menu <?php echo e(request()->routeIs('admin.reports*') || request()->routeIs('admin.activity*') || request()->routeIs('admin.performance.*') ? 'show' : ''); ?>">
                                ...
                                <li><a href="<?php echo e(route('admin.activity.center')); ?>" class="dropdown-item <?php echo e(request()->routeIs('admin.activity.center') ? 'active' : ''); ?>"><i class="fas fa-list-ul"></i> <?php echo e(__('Activity Center')); ?></a></li>
                                <li><a href="<?php echo e(route('admin.activity')); ?>" class="dropdown-item <?php echo e(request()->routeIs('admin.activity') ? 'active' : ''); ?>"><i class="fas fa-stream"></i> <?php echo e(__('Activity API')); ?></a></li>
                            </ul>
                        </div>
                    </div>
    ...
    </nav><?php /**PATH D:\xampp\htdocs\easy\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>