            ...
            <div class="card shadow-sm">
                <div class="card-body text-center">
                    ...
                    <div class="mb-3">
                        ...
                        <strong>{{ __('Amount') }}:</strong> {{ number_format($displayAmount ?? $payment->amount, 2) }} {{ $currencySymbol ?? $payment->currency }}
                    </div>
                    @endif
                    ...
                    <div class="bg-light rounded p-4 mb-4">
                        ...
                        <div class="row text-start">
                            ...
                            <div class="col-sm-6">
                                ...
                                <span class="text-muted">{{ number_format($displayAmount ?? $payment->amount, 2) }} {{ $currencySymbol ?? $payment->currency }}</span>
                            </div>
                        </div>
                    </div>
                    @endif
