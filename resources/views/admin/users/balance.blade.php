                ...
                <div class="card-body">
                    <div class="row g-3 align-items-center">
                        <div class="col-md-6">
                            ...
                            <div class="h2 mb-0 stats-number" data-countup data-target="{{ $user->balance ?? 0 }}">{{ number_format($user->balance ?? 0, 2) }} {{ $defaultCurrency ? $defaultCurrency->symbol : 'USD' }}</div>
                            <div class="text-muted small">{{ __('As of') }} {{ $user->updated_at->format('M d, Y') }}</div>
                        </div>
                    ...
                    <div class="row g-3">
                            ...
                            <div class="card modern-card stats-card stats-card-primary h-100">
                                <div class="stats-card-body d-flex align-items-center">
                                    <div class="stats-card-content flex-grow-1">
                                        <div class="stats-number" data-countup data-target="{{ $balanceStats['total_added'] ?? 0 }}">{{ number_format($balanceStats['total_added'] ?? 0, 2) }} {{ $defaultCurrency ? $defaultCurrency->symbol : 'USD' }}</div>
                                        <div class="stats-label">{{ __('Total Added') }}</div>
                                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="card modern-card stats-card stats-card-info h-100">
                                <div class="stats-card-body d-flex align-items-center">
                                    <div class="stats-card-content flex-grow-1">
                                        <div class="stats-number" data-countup data-target="{{ $balanceStats['total_deducted'] ?? 0 }}">{{ number_format($balanceStats['total_deducted'] ?? 0, 2) }} {{ $defaultCurrency ? $defaultCurrency->symbol : 'USD' }}</div>
                                        <div class="stats-label">{{ __('Total Deducted') }}</div>
                                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="card modern-card stats-card stats-card-success h-100">
                                <div class="stats-card-body d-flex align-items-center">
                                    <div class="stats-card-content flex-grow-1">
                                        <div class="stats-number" data-countup data-target="{{ $balanceStats['net_balance_change'] ?? 0 }}">{{ number_format($balanceStats['net_balance_change'] ?? 0, 2) }} {{ $defaultCurrency ? $defaultCurrency->symbol : 'USD' }}</div>
                                        <div class="stats-label">{{ __('Net Change') }}</div>
                                    </div>
