    ...
    <nav class="account-nav-groups">
        <div class="nav-group">
            ...
            <a href="{{ route('user.returns.index') }}"
                class="nav-link {{ request()->routeIs('user.returns*')? 'active':'' }}">
                <i class="fas fa-undo"></i> {{ __('Returns') }}
            </a>
            <a href="{{ route('wishlist.page') }}" class="nav-link nav-link-badge">
                <i class="fas fa-heart"></i> <span>{{ __('Wishlist') }}</span>
                <span class="badge yellow">{{ $wishlistCount }}</span>
            </a>
            <a href="{{ route('compare.page') }}" class="nav-link nav-link-badge">
                <i class="fas fa-balance-scale"></i> <span>{{ __('Compare') }}</span>
                <span class="badge muted">{{ $compareCount }}</span>
            </a>
        </div>
        <div class="nav-group">
            ...
            <a href="{{ route('user.addresses') }}"
                class="nav-link {{ request()->routeIs('user.addresses*')? 'active':'' }}">
                <i class="fas fa-map-marker-alt"></i> {{ __('Addresses') }}
            </a>
            <a href="{{ route('user.invoices') }}"
                class="nav-link {{ request()->routeIs('user.invoices')? 'active':'' }}">
        ...
        <div class="nav-group">
            ...
            <a href="{{ route('vendor.dashboard') }}" class="btn btn-primary btn-sm w-100 mb-2">
                <i class="fas fa-store"></i> {{ __('Vendor Dashboard') }}
            </a>
            @endif
